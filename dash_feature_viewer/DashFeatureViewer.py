...
- featureSelected (dict; optional): The Style of Viewer."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, options=Component.UNDEFINED, sequence=Component.UNDEFINED, features=Component.UNDEFINED, viewerStyle=Component.UNDEFINED, featureSelected=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'options', 'sequence', 'features', 'viewerStyle', 'featureSelected']
        self._type = 'DashFeatureViewer'
        self._namespace = 'dash_feature_viewer'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'options', 'sequence', 'features', 'viewerStyle', 'featureSelected']
